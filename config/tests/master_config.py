...
class Config(config_dict.ConfigDict):
    ...
    def __init__(self):
        ...
        self.segmentation_key = None # constants.SegmentationKey.CNN_VENT.value
        ...
        self.hb = 0.0
        self.subject_id = "undefined" # "demo"  # "PIm0377"
        self.rbc_m_ratio = 0.0 # 0.575
...
class ReferenceData(object):
    ...
    def __init__(self, reference_data_key):
        ...
        if (
            ...
            self.threshold_vent = np.array(
                [0.3621, 0.5724, 0.7265, 0.8543, 0.9662])
            self.threshold_rbc = np.array(
                [0.1007, 0.2723, 0.512, 0.814, 1.1743]) * 1e-2
            self.threshold_membrane = (
                np.array([0.3826, 0.5928, 0.8486,
                         1.1498, 1.4964, 1.8883, 2.3254])
                * 1e-2
            )
