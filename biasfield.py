...
def correct_biasfield_n4itk(
    ...
    logging.info("Correcting biasfield with N4ITK")
    ...
    logging.info("Reading in input, mask, output and biasfield files")
...
def main(argv):
    ...
    logging.info(f'Saved image_cor to {os.path.join(output_path, "image_cor.nii")}') 
    ...
    logging.info(f'Saved biasfield to {os.path.join(output_path, "biasfield.nii")}') 
